...
def increase_like_count(d_util, user_id, post_id):
    ...
    from a5 import query_user_like_by_post_id
...
def decrease_like_count(d_util, user_id, post_id):
...
def get_like_count_by_post_id(d_util, post_id):
    return d_util.get_item({"PK": f"p#{post_id}#likecount", "SK": "count"})
