...
def test_increase_like(d_util, user_id, post_id, expected):
    increase_like(d_util, user_id, post_id)
    assert query_user_like_by_post_id(d_util, post_id) == expected["likelist"]["list"]
...
def test_decrease_like(d_util, user_id, post_id, expected):
    decrease_like(d_util, user_id, post_id)
    assert query_user_like_by_post_id(d_util, post_id) == expected["likelist"]["list"]
